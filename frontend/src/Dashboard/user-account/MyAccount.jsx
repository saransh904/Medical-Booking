  ...
  return (
    ...
    <div className='max-w-[1170px] px-5 mx-auto'>
      ...
      <div className='grid md:grid-cols-3 gap-10'>
        <div className='pb-[50px] px-[30px] rounded-mb'>
        ...
        <div className='mt-[50px] md:mt-[100px]'>
            ...
            <button onClick={handleNav} className='w-full bg-primaryColor mt-4 p-3 text-[16px] leading-7 rounded-md text-white'>Book Appointment</button>
        </div>
