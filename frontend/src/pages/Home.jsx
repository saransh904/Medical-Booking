  ...
  <>
        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio eveniet unde quas repellat! Eum ipsum aliquam explicabo numquam autem necessitatibus eaque magnam repellendus, odio unde?
            </p>
            <button onClick={handleNavigate} className='btn'>Request an Appointment</button>
            </div>
            ...
            <div className='mt-[30px] lg:mt[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
             ...
             <div>
                ...
                <p className='text__para'>Patient Staisfaction</p>
             </div>
    ...
    <section>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 ls:gap-[30px] mt-[30px] lg:mt-[55px]'>
    ...
    {/*============== services section ===============*/}
      <section>
        <div className='conatiner px-[40px]'>
          <div className='xl:w-[470px] mx-auto'>
            <h2 className='heading text-center '>Our medical services</h2>
            <p className='text__para text-center'>World class care for everyone. Our health System offers unmatched expert health co
            </p>
          </div>
            ...
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-[60px] lg:gap-3'>
                  ...
                  <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-textColor text-headingColor font-[400]'>10:00AM</p>
                </div>
