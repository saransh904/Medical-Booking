        ...
        <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5 '>
              ...
              <div>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>Surgeon
                </span>
                ...
                <div className='flex items-center gap-[6px]'>
                  ...
                  <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font[400] text-textColor'>(349)</span>
                </div>

                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum, quaerat.</p>
              </div>
            </div>
